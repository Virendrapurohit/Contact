  ...
  React.useEffect(() => {
    if (id) {
      ...
      Service.get(id)
        .then((res) => {
          setInitial(
            Object.entries(res.data).reduce((carry: any, [key, value]) => {
        ...
        {!loader && (
          <Formik
            ...
            onSubmit={(values, Actions) => {
              Service.post(id ? id : "", values).finally(() => {
                ...
                <>
                  ...
                  >
                    <TextField
                      ...
                      errorMessage={
                        errors?.phonenumber ? (errors?.phonenumber as any) : ""
                      }
                    />
                    <Dropdown
                      label="Qualification"
                  ...
                  >
                    <TextField
                      ...
                      errorMessage={
                        errors?.address ? (errors?.address as any) : ""
                      }
                    />
                  </Stack>
                  <Stack
                  ...
                  >
                    ...
                    <TextField
                      ...
                      errorMessage={
                        errors?.country ? (errors?.country as any) : ""
                      }
                    />
                  </Stack>
                  <Stack
                  ...
                  >
                    <TextField
                      ...
                      name="pinCode"
                      errorMessage={
                        errors.pincode ? (errors?.pincode as any) : ""
                      }
                      onChange={(e, v) => {
                  ...
                  >
                    <Dropdown
                      ...
                      errorMessage={
                        errors?.currentyearlyctc
                          ? (errors?.currentyearlyctc as any)
                          : ""
                      }
                      options={[
                    ...
                    <Dropdown
                      ...
                      errorMessage={
                        errors?.expectedyearlyctc
                          ? (errors?.expectedyearlyctc as any)
                          : ""
                      }
                    />
                  </Stack>
